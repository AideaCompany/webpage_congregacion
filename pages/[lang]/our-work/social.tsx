...
export const getStaticProps: GetStaticProps = async ctx => {
  ...
  const data = ((await client.query({ query: gql(getPages), variables: { name: 'social' } })) as { data: { getPages: any } }).data.getPages
  const data_misions = ((await client.query({ query: gql(getMisionWebToWeb), variables: { type: 'Social' } })) as {
