                        ...
                        <div className="spirituality__index">
                            ...
                            <div className="blog__entries">
                                <div className="container__carousel">
                                    { }
                                    <Carousel>
                                        {entries.map((e, ie) => ie % 2 == 0 && [e, entries[ie + 1]])
                                            .filter(e => e)
                                            .map((ge, gi) => <div key={gi} className='item'>
                                                {ge.map((en, eni) => <div key={eni} className='entrada'><HeaderCard title={en.title} text={en.cont} img={en.img} /></div>)}
                                            </div>)}
                                    </Carousel>
                                </div>
                            </div>
